   ...
   <div class="row">
      ...
      <div id="content-wrapper" class="d-flex flex-column">
       ...
       <div class="row">
           ...
           <img src="<?=base_url().'/image/'.$lowongan->foto?>" height="200" class="card-img-top " alt="...">
               </div>
           </div>
           <div class="col-6">
               <table class="table table-bordered">
                   <tbody>
                       <tr>
                           <td class="bg-primary text-white">Deskripsi Pekerjaan :</td>
                           <td><?= $lowongan->deskripsi_pekerjaan?></td>
                       </tr>

                       <tr>
                           <td class="bg-primary text-white">Batas Akhir :</td>
                           <td><?= $lowongan->tanggal_akhir?></td>
                       </tr>

                       <tr>
                           <td class="bg-primary text-white">Mitra :</td>
