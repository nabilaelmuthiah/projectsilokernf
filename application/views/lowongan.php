...
<meta charset="utf-8">
  ...
  <body>
    ...
    <div class="container-fluid">
        <a href="<?= base_url()?>index.php/lowongan/add" class="btn btn-light">add</a><br><br>
      <table class="table align-items-center table-flush table-light">
        ...
        echo'
          <tr>
            ...
            <td> <img src="'.base_url().'image/'.$lowongan->foto.'"  width="100" height="100"alt=""></td>
            <td><a href="'.base_url().'index.php/lowongan/view/'.$lowongan->id.'">View</a>
                <a href="'.base_url().'index.php/lowongan/edit/'.$lowongan->id.'"><i class="far fa-edit">Edit</i></a>
                <a  onclick="return confirm(‘Yakin Hapus?’)" href="'.base_url().'index.php/lowongan/delete/'.$lowongan->id.'">Delete</a></td>
            </tr>';
            $nomor++;
         }?>
        </tbody>
