    ...
    <nav class="navbar navbar-fixed navbar-expand-lg navbar-light" style="background-color: #C4D4ED;"> 
      ...
      <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="row mb-4">
                <input type="hidden" name="id" id="id" value="<?php echo $mitra->id; ?>"/>   
                    <label for="">Foto lama <br>
                        <img src="<?=base_url().'/image/'.$mitra->foto?>"  alt="" width="100" height="100">
                        <div class="col-sm-8">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="nama_perusahaan" name="nama" value="<?php echo $mitra->nama; ?>"required>
                    </div>
                  </div>
                        <div class="row mb-4">
                    <label for="deskripsi_lowongan" class="col-sm-2 col-form-label">Alamat</label>
                    <div class="col-sm-8">
                        <input class="form-control" id="alamat" rows="2" name="alamat" value="<?= $mitra->alamat ?>" required>
                    </div>
                  </div>
                  <div class="row mb-4">
                    <label for="kontak_person" class="col-sm-2 col-form-label ">Kontak Person</label>
                    <div class="col-sm-8">
                      <input class="form-control" type="text" id="cp" name="kontak" value="<?= $mitra->kontak?>" required>
                    </div>
                    </div>
                    <div class="row mb-4">
                    <label for="telpon" class="col-sm-2 col-form-label ">Telpon</label>
                    <div class="col-sm-8">
                      <input class="form-control" type="tel" id="telpon" name="telpon" value="<?= $mitra->telpon?>" required>
                    </div>
                    </div>
                    <div class="row mb-4">
                      <label for="email" class="col-sm-2 col-form-label">Email</label>
                      <div class="col-sm-8">
                        <input class="form-control" type="email" id="email" name="email" value="<?= $mitra->email?>" required>
                    </div>
                    </div>
                    <div class="row mb-4">
                      <label for="web" class="col-sm-2 col-form-label">Alamat Web</label>
                      <div class="col-sm-8">
                        <input class="form-control" type="text" id="web" name="web" value="<?=$mitra->web?>" required>
                    </div>
                    </div>
                  <div class="row mb-4">
